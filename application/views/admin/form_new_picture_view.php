<div class="col-md-6 ml-auto admin-form" id="picture-form">
  <div class="card card-outline-secondary">
    <div class="card-header">
      <h2 class="mb-0">Nouveau visuel</h2>
    </div>
    <div class="card-body">

    <?php
      echo form_open_multipart('administration/pictures/view/'.$project_id.'/new', ['class' => 'form', 'autocomplete'=>'off']);
        ...
        echo '<div class="form-group row">';
          ...
          ?><div class="col-md-9"><?php
          echo form_input(['name' => "alt", 'id' => "alt", 'class' => $class_alt], set_value('alt', '', FALSE), 'required');
        ...
        ?>
          <div class="col-md-9 ml-auto text-right">
            ...
            <?php echo anchor('administration/pictures/view/'.$project_id.'/new', 'Annuler', ['class'=>'btn btn-secondary', 'role'=>'button']); ?>
