<div class="col-md-10 admin-form">
  <div class="card card-outline-secondary">
    ...
    <div class="card-body">
    <?php
      echo form_open('administration/projects/edit/'.$id, ['class' => 'form', 'autocomplete'=>'off']);
        ...
        echo '<div class="form-group row">';
          ...
          ?><div class="col-md-10"><?php
          echo form_dropdown('category_id', $opt_categories , $category_id,['id' => "category_id", 'class' => 'form-control'], set_value('category_id'), 'required');
        ...
        echo '<div class="form-group row">';
          ...
          ?><div class="col-md-10"><?php
          echo form_input(['name' => "context", 'id' => "context", 'class' => $class_context], set_value('context', $context, FALSE), 'required');
        ...
        echo '<div class="form-group row">';
          ...
          ?><div class="col-md-10"><?php
          echo form_textarea(['name' => "description", 'id' => "description", 'class' => $class_description, 'rows'=>'6'], set_value('description', $description, FALSE), 'required');
        ...
        echo '<div class="form-group row">';
          ...
          ?><div class="col-md-10"><?php
          echo form_input(['name' => "external_link", 'id' => "external_link", 'class' => $class_external_link, 'type'=>'url'], set_value('external_link', $external_link, FALSE));
        ...
        ?>
          <div class="col-md-9 ml-auto text-right">
            ...
            <?php echo anchor('administration/projects/edit/'.$id, 'Annuler', ['class'=>'btn btn-secondary', 'role'=>'button']); ?>
